...
![Preview](https://raw.githubusercontent.com/chefboyrd53/oldcord/master/.github/preview.webp)

<details> <summary><strong>Light mode</strong></summary>

<img src=https://raw.githubusercontent.com/chefboyrd53/oldcord/master/.github/previewLight.webp>
...
| Name                   | Preview                                                                                | CSS                                                                                |
| ---------------------- | ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------- |
| Old Plead Emoji        | ![Image](https://raw.githubusercontent.com/chefboyrd53/oldcord/master/.github/emojis.webp)     | `@import url("https://chefboyrd53.github.io/oldcord/src/components/oldEmojis.css");`   |
| Context Menu hover bg. | <img src=https://raw.githubusercontent.com/chefboyrd53/oldcord/master/.github/oldcontext.webp> | `@import url("https://chefboyrd53.github.io/oldcord/src/components/oldContext.css");`  |
| Show Profile Cosmetics (Light theme not supported for now) | ![Image](https://raw.githubusercontent.com/chefboyrd53/oldcord/master/.github/showeffects.webp)                                                           | `@import url("https://chefboyrd53.github.io/oldcord/src/components/showEffects.css");` |
...
1. Download [OldCord.theme.css](https://raw.githubusercontent.com/chefboyrd53/oldcord/main/OldCord.theme.css) (right-click > "Save As")
...
- `https://chefboyrd53.github.io/oldcord/src/main.css`
...
```css
@import url("https://chefboyrd53.github.io/oldcord/src/main.css");
```
----
